...
var WinterHat4 = /** @class */ (function (_super) {
    ...
    function WinterHat4() {
        ...
        _this.filter1 = (0, uniqueId_1.getUniqueId)('react-filter-');
        _this.mask1 = (0, uniqueId_1.getUniqueId)('react-mask-');
        _this.mask2 = (0, uniqueId_1.getUniqueId)('react-mask-');
        _this.mask3 = (0, uniqueId_1.getUniqueId)('react-mask-');
        _this.mask4 = (0, uniqueId_1.getUniqueId)('react-mask-');
        _this.path1 = (0, uniqueId_1.getUniqueId)('react-path-');
        _this.path2 = (0, uniqueId_1.getUniqueId)('react-path-');
        _this.path3 = (0, uniqueId_1.getUniqueId)('react-path-');
        _this.path4 = (0, uniqueId_1.getUniqueId)('react-path-');
        _this.path5 = (0, uniqueId_1.getUniqueId)('react-path-');
        return _this;
    }
